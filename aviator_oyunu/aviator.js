document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!activeUser || !users[activeUser]) {
        window.location.href = '../../index.html'; // Aviator klasöründen iki seviye yukarı (ana login)
        return;
    }
    ...
    airplaneImage.src = '../assets/images/airplane.png'; // Uçak görselinin yolu (Burada ../assets/images/airplane.png olarak kalacak çünkü assets klasörü ana dizinde)
    ...
    function drawGrid() {
        ...
        for (let i = 0; i < gameCanvas.width; i += 40) {
            ...
            ctx.lineTo(i, 0); // Bu satır sanırım yanlışlıkla tekrarlandı, orijinalde yoktu.
            ctx.stroke();
        }
    }
