document.addEventListener('DOMContentLoaded', () => { // TÜM KODU BU BLOĞUN İÇİNE TAŞIDIK
    ...
    const registerButton = document.getElementById('registerButton'); // Hatanın ana kaynağı burasıydı
    ...
    showTab('login'); // Bu satır DOMContentLoaded içinde olduğu için artık sorun yok
});
